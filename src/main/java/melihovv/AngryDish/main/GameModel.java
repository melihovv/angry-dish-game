...
import melihovv.AngryDish.collisions.BirdToPigCollision;
import melihovv.AngryDish.collisions.BirdToWoodenObstacleCollision;
import melihovv.AngryDish.collisions.PlayerToComputerBirdCollision;
import melihovv.AngryDish.events.BirdListener;
import melihovv.AngryDish.events.ModelListener;
...
public class GameModel implements BirdListener {
     ...
     */
    private AngryDishGame _gameInstance;
     ...
     */
    public GameModel(final AngryDishGame gameInstance) {
    ...
    private class AIController
            implements melihovv.AngryDish.controllers.AIController {
        /**
    ...
    private class PlayerController
            implements melihovv.AngryDish.controllers.PlayerController {
        /**
