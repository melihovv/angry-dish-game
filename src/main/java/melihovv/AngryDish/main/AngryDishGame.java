...
import melihovv.AngryDish.views.FieldView;
import melihovv.AngryDish.views.GameView;
 ...
 * window size.
 */
public class AngryDishGame extends GameObject implements ModelListener {
    /**
     ...
     */
    public AngryDishGame(final GameEngine gameEngine) {
        super(gameEngine);
